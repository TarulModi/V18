...
class srRentalPricing(models.Model):
    ...
    unit = fields.Selection([('hour', 'Hours'), ('day', 'Days'), ('week', 'Weeks'), ('month', 'Months')],"Unit")
    lot_ids = fields.Many2many("stock.lot", string="Serial Number")
    price = fields.Float("Price")
    currency_id = fields.Many2one("res.currency","Currency Id",default=lambda self: self.env.user.company_id.currency_id.id)
