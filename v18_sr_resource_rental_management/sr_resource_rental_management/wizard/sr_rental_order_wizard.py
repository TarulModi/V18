...
class srRentalOrderLine(models.TransientModel):
    ...
    rental_order_status = fields.Selection(related='rental_order_id.rental_order_status', string="Rental Order Status")
    order_line_id = fields.Many2one('sale.order.line', required=True, ondelete='cascade')
    product_id = fields.Many2one('product.product', string='Product', required=True, ondelete='cascade')
    lot_ids = fields.Many2many("stock.lot", string="Serial Number", required=True)
